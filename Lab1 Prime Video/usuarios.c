...
void usuarios(Usuario aux)
{
    ...
    do
    {
        ...
        {
        case 1:
            cargarUsuario(archivoUsuarios, 1,archivoPeliculas);
            break;
...
//igual a buscarNombreUsuario pero sin mostrar el usuario
int validarRepeticionNombre(char archivoUsuarios[], char nombreUsuario[]){
FILE * arch;
    arch=fopen(archivoUsuarios, "rb");
    Usuario aux;
    int flag = 0;
...
int cargarUsuario(char archivoUsuarios[], int isadmin, char archivoPeliculas[])
{
    FILE *arch;
    ...
    //validar nombre mayor a 3 caracteres
    while(strlen(aux.nombre)<4){
    printf("Por favor, ingrese un nombre mayor a 3 caracteres\n");
    gets(aux.nombre);
    }

    while (validarRepeticionNombre(archivoUsuarios, aux.nombre) !=0)
    {
        printf("\nError: Usuario existente, ingrese otro nombre\n");
        gets(aux.nombre);
        ...
        //validar contraseña mayor a 3 caracteres
         while(strlen(aux.contrasenia)<4){
        printf("Por favor, ingrese una contraseña mayor a 3 caracteres\n");
        gets(aux.contrasenia);
    }
        ...
        gets(aux.celular);
         ...
         //validar telefono mayor a 6 caracteres
         while(strlen(aux.celular)<7){
        printf("Por favor, ingrese un telefono mayor a 6 caracteres\n");
        gets(aux.celular);
    }
        ...
        //validar mail con "@" y ".com"
        while(strstr(aux.mail,"@")==NULL || strstr(aux.mail,".com")==NULL){
            printf("Por favor, ingrese un mail valido\n");
            gets(aux.mail);
        }
        ...
        while(getch()=='s' && i !=49)
        {
            ...
            ///falta chequear que el id exista
            printf("\nIngrese id: ");
